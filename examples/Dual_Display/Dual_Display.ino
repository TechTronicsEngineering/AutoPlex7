...
void loop() {
  ...
  SecondsDisplay.print(seconds); // Show the number of elapsed seconds on the first display
  ...
  FractionalDisplay.print(fraction); // Show the numbers after the decimal on the 2nd display
}
